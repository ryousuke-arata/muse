      ...
      <div class="post-header-nav">
       <div class="container">
        <ul>
             ...
             <li class="post-header-nav-item"><a href="http://localhost:81/muse_match/public/user-followeds">フォロー</a></li>
             <li class="post-header-nav-item"><a href="http://localhost:81/muse_match/public/user-followings">フォロワー</a></li>
        </ul>
       </div>
      </div>
    @endif
